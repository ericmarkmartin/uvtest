...
from netket_pro.driver import MidpointInfidelity_SR
from netket_pro.jumps.networks import Jastrow_zz_frozen
from netket_pro.optimizer.L_curve import lcurve_solver_sr, gcv_solver_sr
...
auto_solvers = [
    pytest.param(lcurve_solver_sr, id="lcurve"),
    pytest.param(gcv_solver_sr, id="gcv"),
]
